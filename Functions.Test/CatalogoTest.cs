...
namespace Functions.Test
{
    ...
    public class CatalogoTests
    {
        ...
        public async void InsertCombo()
        {
            ...
            int Precio = 100;
            int EventId = 1;
            string conn_str = "Server=tcp:catalogoserver.database.windows.net,1433;Initial Catalog=catalogoDatabase;Persist Security Info=False;User ID='';Password='';MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
